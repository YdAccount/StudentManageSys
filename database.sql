...
'计算机科学与技术','110', '123456', '北京', '喜欢写代码', '无', '1998-1-21');
...
'计算机科学与技术','110', '123456', '北京', '喜欢写代码', '无', '1998-1-21',1);
-- 常用命令
delete from tb_users where u_no = '123';
drop database PMS;
alter database PMS default character set 'utf8';
show create table tb_users;
alter table tb_users character ;
insert into tb_users (u_no, u_department) values ('211', '解决');
select u_birthday from tb_users where u_no = '123';
